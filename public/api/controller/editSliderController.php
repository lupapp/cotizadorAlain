...
if(isset($_POST['submit'])){
    ...
    if (empty($bg)){
        ...
        header('Location: ../view/desktop/editSlide.php?id='.$id.'&id_cat='.$id_propietario.'&ms='.$param["ms"].'&clase='.$param["clase"].'&alert='.$param["alert"].'');

    }else {
        $slider->setId_propietario($id_propietario);
        $slider->setBg($bg);
        $slider->setImg($img);
