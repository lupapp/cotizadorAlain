...
class Slider extends Mysqli
{
    ...
    public function save(){
        $query="INSERT INTO sliders (id,id_propietario,bg,img,imgDataX,imgDataY,imgDataSpeed,imgDataStart,imgEfecto,imgWidth,imgHeight,caption,captionDataX,captionDataY,"
        ...
        ."VALUES (NULL,'".$this->id_propietario."','".$this->bg."','".$this->img."','".$this->imgDataX."','".$this->imgDataY."','".$this->imgDataSpeed."',"
    ...
    public function getByIdPropietario($id_propietario){
        $resultset=[];
        $query=$this->con->query("SELECT * FROM sliders WHERE id_propietario=$id_propietario");
        while($row=$query->fetch_object()){
            $resultset[]=$row;
        }
        return $resultset;
    ...
    public function update($id){
        $query="UPDATE sliders SET id_propietario='".$this->id_propietario."',bg='".$this->bg."',img='".$this->img."',imgDataX='".$this->imgDataX."',imgDataY='".$this->imgDataY."',imgDataSpeed='".$this->imgDataSpeed."',"
